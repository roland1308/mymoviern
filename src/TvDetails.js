...
class TvDetails extends Component {
  ...
  componentDidMount() {
    ...
    if (serieIndex !== -1) {
      ...
      this.setState({
        oldStarVote: serieStars[serieIndex],
        newStarVote: serieStars[serieIndex],
        position: serieIndex,
      });
    } else {
    ...
    if (prevProps.general.toggleNext != this.props.general.toggleNext) {
      ...
      if (!alreadyNext) {
        const data = {
          ...
          id: `s${this.props.route.params.detailsId}`,
        };
  ...
  async getDetails(uri) {
    ...
    const request1 = await axios.get(
      'https://mymoviesback.herokuapp.com/series/getstats/' +
  ...
  render() {
    ...
    return (
      <Layout style={styles.container}>
        ...
        >
          <Card disabled={true}>
            <Text>As you saw this serie, please value it</Text>
        ...
        {/* {whoStarredVisible ? this.addMovieStar : null} */}
        ...
        <Separator />
        <Layout
          style={{padding: 5, flexDirection: 'row', justifyContent: 'center'}}
        >
