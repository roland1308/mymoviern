...
import { Layout, Text, Spinner, Modal, Card, Button } from '@ui-kitten/components';
...
class MovieDetailsRemove extends Component {
    ...
    componentDidMount() {
        ...
        let uri = "https://api.themoviedb.org/3/movie/" + detailsId + "?api_key=" + API_KEY + "&language=" + this.props.general.language
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.route.params.source != this.props.route.params.source) {
            if (this.props.route.params.source === "remove") { this.setState({ removeVoteVisible: true }) }
        }
    }
